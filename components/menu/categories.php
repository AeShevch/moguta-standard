<?php
addScript('/components/menu/js/jquery.hoverIntent');
addScript('/components/menu/js/categories');
addStyle('/components/menu/css/categories');
?>
                            ...
                            <a class="c-nav__link c-nav__link--1 c-nav__link--arrow c-catalog__link c-catalog__link--1 c-catalog__link--arrow"
                               href="<?php echo $category['link']; ?>">
                                <?php if (!empty($category['menu_icon'])): ?>
                                    <div class="c-nav__img c-catalog__img"><img
                                                src="<?php echo SITE . $category['menu_icon']; ?>"
                                                alt="<?php echo $category['menu_seo_alt']; ?>"
                                                title="<?php echo $category['menu_seo_title']; ?>"></div>
                                <?php endif; ?>
