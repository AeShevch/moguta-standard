                                                ...
                                                <div class="c-product__row">
                                                    <ul class="product-status-list">
                                                        <li <?php echo (!$data['weight']) ? 'style="display:none"' : 'style="display:block"' ?>>
                                                            ...
                                                            <span class="label-black weight"><?php echo $data['weightCalc'] ?></span> <?php echo lang('weightUnit_'.$data['weightUnit']); ?>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="c-tab">
                            ...
                            <?php if (!empty($data['stringsProperties'])): ?>
                                <div class="c-tab__content" id="c-tab__property">
                                    <?php echo MG::layoutManager('layout_prop_string', $data['stringPropertiesSorted']); ?>
                                </div>
                            <?php endif; ?>
                            <?php if (class_exists('ProductCommentsRating')): ?>
