                    ...
                    <form class="c-form c-form--width" action="<?php echo SITE ?>/personal" method="POST">
                        ...
                        <div class="c-form__row">
                            <input class="birthday"
                                   type="text"
                                   name="birthday"
                                   value="<?php echo $userInfo->birthday?date('d.m.Y', strtotime($userInfo->birthday)):'' ?>" placeholder="<?php echo lang('personalBirthday'); ?>">
                        </div>
                        <div class="c-form__row">
                            <input type="text"
                                   name="phone"
                                        ...
                                        <div class="c-history__content--left">
                                            ...
                                            <?php if($order['status_id']<2): ?>
                                                <div class="order-settings">
                                                    <div class="c-history__row">
                                                        <a href="#js-modal__reason" class="c-button c-button--border close-order" id="<?php echo $order['id'] ?>" date="<?php echo date('d.m.Y', strtotime($order['add_date'])) ?>" data-number="<?php echo $order['number']!=''?$order['number']:$order['id']; ?>">
                                                            <?php echo lang('orderCancel'); ?>
                                                        </a>
                                                    </div>
                                                    <?php $urInfo = unserialize(stripcslashes($order['yur_info'])); if(empty($urInfo['inn'])) { ?>
                                                    <div class="c-history__row">
                                                        <a href="#js-modal__payment" class="c-button c-button--border change-payment" id="<?php echo $order['id'] ?>" date="<?php echo date('d.m.Y', strtotime($order['add_date'])) ?>" data-number="<?php echo $order['number']!=''?$order['number']:$order['id']; ?>">
