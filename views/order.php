...
<?php addScript('standard_core/js/order'); ?>
<?php addStyle('standard_core/css/datepicker'); ?>
                    ...
                    <div class="l-row">
                        ...
                        <div class="l-col min-0--12 min-768--6 min-990--3">
                                        ...
                                        <li <?php echo ($delivery['checked']) ? 'class = "active"' : 'class = "noneactive"' ?>>
                                            <label data-delivery-date="<?php echo $delivery['date']; ?>"
                                                ...
                                                <span class="deliveryPrice"
                                                      style="<?php echo $deliveryCostShow ? '' : 'display:none;'; ?>">&nbsp;<?php echo MG::numberFormat($delivery['cost']); ?></span>
                                                <span class="deliveryCurrency"
                                                      style="<?php echo $deliveryCostShow ? '' : 'display:none;'; ?>"><?php echo '&nbsp;' . $data['currency']; ?></span>
                                            </label>
                                            <!--
                            ...
                            <div class="delivery-date" style="display:none;">
                                ...
                                <input type='text' name='date_delivery'
                        ...
                        <div class="l-col min-0--12 min-990--6">
                            ...
                            if (EDITION == 'gipermarket') {
                                ...
                                <ul class="c-order__list form-list">
                                    <li class="c-order__list--item"><input type="text" name="email" placeholder="Email"
                                                                           value="<?php echo $_POST['email'] ?>"></li>
                                    <li class="c-order__list--item"><input type="text" name="phone"
                                                                           placeholder="<?php echo lang('phone'); ?>"
                                                                           value="<?php echo $_POST['phone'] ?>"></li>
                                    <?php if (MG::getSetting('useNameParts') == 'true') { ?>
                                        <li class="c-order__list--item">
                                            <input type="text" name="fio_sname"
                                                   placeholder="<?php echo lang('fname') ?>"
                                                   value="<?php echo $_POST['fio_sname'] ?>">
                                        </li>
                                        <li class="c-order__list--item">
                                            <input type="text" name="fio_name" placeholder="<?php echo lang('lname') ?>"
                                                   value="<?php echo $_POST['fio_name'] ?>">
                                        </li>
                                        <li class="c-order__list--item">
                                            <input type="text" name="fio_pname"
                                                   placeholder="<?php echo lang('pname') ?>"
                                                   value="<?php echo $_POST['fio_pname'] ?>">
                                        </li>
                                    <?php } else { ?>
                                        <li class="c-order__list--item">
                                            <input type="text" name="fio" placeholder="<?php echo lang('fio') ?>"
                                                   value="<?php echo $_POST['fio'] ?>">
                                        </li>
                                    <?php } ?>
                                    <li class="c-order__list--item">
                                        <input type="text" class="address-area"
                                               placeholder="<?php echo lang('orderPhAdres'); ?>" name="address"
                                    ...
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressIndex'); ?>"
                                               name="address_index" value="<?php echo $_POST['address_index'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressCountry'); ?>"
                                               name="address_country" value="<?php echo $_POST['address_country'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressRegion'); ?>"
                                               name="address_region" value="<?php echo $_POST['address_region'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressCity'); ?>"
                                               name="address_city" value="<?php echo $_POST['address_city'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressStreet'); ?>"
                                               name="address_street" value="<?php echo $_POST['address_street'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressHouse'); ?>"
                                               name="address_house" value="<?php echo $_POST['address_house'] ?>">
                                    </li>
                                    <li class="c-order__list--item addressPartsContainer">
                                        <input type="text" placeholder="<?php echo lang('orderPhAddressFlat'); ?>"
                                               name="address_flat" value="<?php echo $_POST['address_flat'] ?>">
                                    </li>

                                    <li class="c-order__list--width"><textarea class="address-area"
                                ...
                                <div class="c-order__total">
                                    ...
                                    <?php if ($data['captcha'] && !$data['recaptcha']) { ?>
                                        <div class="checkCapcha" style="display:inline-block">
                                            ...
                                            <div class="capcha-text"><?php echo lang('captcha'); ?><span
                                                        class="red-star">*</span>
                                            </div>
                                    ...
                                    <div class="c-order__total--row">
                                        <form action="<?php echo SITE ?>/order" method="post" class="checkout-form">
                                            <input type="submit" name="toOrder" class="checkout-btn default-btn success"
                                                   value="<?php echo lang('checkout'); ?>" disabled>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="l-col min-0--12">
                <div class="c-alert c-alert--blue 6">
                    <p><?php echo lang('orderPaymentForm4'); ?>
                        <b>№ <?php echo $data['orderNumber'] ?></b> <?php echo lang('orderPaymentForm5'); ?>
                        <b><?php echo MG::numberFormat($data['summ']) ?></b> <?php echo $data['currency']; ?></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
                        ...
                        <div class="c-table c-table--hover c-history__table">
                            <table class="status-table">
                                ...
                                <?php if (!empty($perOrders)) foreach ($perOrders as $perOrder): ?>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="c-history__table--title" href="<?php echo $perOrder['url'] ?>"
                                               target="_blank">
