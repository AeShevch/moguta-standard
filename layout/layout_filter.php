        ...
        <ul> 
          <li>
            <label style="margin-bottom:8px;">
              <input type="checkbox" name="sale" value="1" class="mg-filter-prop-checkbox" <?php echo isset($_REQUEST['sale'])?'checked':''; ?>>
          ...
          <li>
            <label style="margin-bottom:8px;">
              <input type="checkbox" name="new" value="1" class="mg-filter-prop-checkbox" <?php echo isset($_REQUEST['new'])?'checked':''; ?>>
          ...
          <li>
            <label style="margin-bottom:8px;">
              <input type="checkbox" name="recommend" value="1" class="mg-filter-prop-checkbox" <?php echo isset($_REQUEST['recommend'])?'checked':''; ?>>
  ...
  <?php }else{ ?>
    ...
    <a role="button" href="javascript:void(0);" class="refreshFilter"><span><?php echo lang('filterReset'); ?></span></a> 
  <?php } ?>
