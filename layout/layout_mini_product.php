<div class="c-goods__item product-wrapper"
    ...
    <meta itemprop="sku" content="<?php echo $data['item']["code"] ?>">
...
?>
            <a role="button" href="javascript:void(0);" data-item-id="<?php echo $data['item']['id']; ?>"
            ...
            <a role="button" href="javascript:void(0);" data-item-id="<?php echo $data['item']['id']; ?>" class="mg-add-to-favorites"
...
<span itemprop="name" class="hidden"><?php echo $data['item']["title"] ?></span>
    ...
    <div class="c-goods__right" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
        <link itemprop="url" href="<?php echo $data['item']["link"] ?>">
        <?php
        ...
        <div class="c-goods__price">
            ...
            <div class="c-goods__price--current product-price">
                <span itemprop="price" content="<?php echo MG::numberDeFormat($data['item']["price"]); ?>"><?php echo priceFormat($data['item']["price"]) ?></span>
        ...
        <div itemprop="description" class="c-goods__description">
            <?php 
            if ($data['item']["short_description"]) {
                echo MG::textMore($data['item']["short_description"], 80);
                } else {
